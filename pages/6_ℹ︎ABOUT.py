...
with st.container(border=True):
    st.markdown("""
        Berikut adalah video YouTube yang menjelaskan tentang K-Means Clustering. Anda dapat menonton video ini langsung di YouTube untuk memperoleh pemahaman yang lebih baik tentang metode tersebut.
    """)

    # Embed YouTube video for K-Means Clustering
...
# Container for YouTube video about Agglomerative Hierarchical Clustering (AHC)
with st.container(border=True):
    st.markdown("""
        Berikut adalah video YouTube yang menjelaskan tentang Agglomerative Hierarchical Clustering (AHC). Anda dapat menonton video ini langsung di YouTube untuk memperoleh pemahaman yang lebih baik tentang metode tersebut.
    """)

    # Embed YouTube video for Agglomerative Hierarchical Clustering (AHC)
